...
export default {
  ...
  methods: {
    ...
    async getActivityList() {
      const {data: res} = await this.$http.get('/api/jiahe/list_committees_members', {params: this.queryInfo});
  ...
  <div>
    ...
    <el-card class="box-card">
      <div>
        ...
        <el-table :data="activityList" border stripe>
          ...
          <el-table-column label="duty" prop="duty"></el-table-column>
          <el-table-column label="dutyDescription" prop="dutyDescription" width="200"></el-table-column>
    ...
    >
      ...
      <!--
          ...
          "images": "http://127.0.0.1:9000/jiaxiang/2025/04/09/xinghuo2.jpg"
      }-->
      <el-form :model="addForm" :rules="addFormRules" ref="addFormRef" label-width="100px">
        ...
        <el-form-item label="任务" prop="duty">
          <el-input v-model="addForm.duty" placeholder="格式: YYYY-MM-DD HH:MM:SS"></el-input>
        </el-form-item>
        <el-form-item label="任务描述" prop="dutyDescription">
          <el-input v-model="addForm.dutyDescription" placeholder="格式: YYYY-MM-DD HH:MM:SS"></el-input>
        </el-form-item>
      </el-form>
    ...
    >
      <el-form :model="editForm" :rules="editFormRules" ref="editFormRef" label-width="100px">
        ...
        <el-form-item label="任务介绍" prop="dutyDescription">
          <el-input type="textarea" v-model="editForm.dutyDescription" rows="4"></el-input>
        </el-form-item>
