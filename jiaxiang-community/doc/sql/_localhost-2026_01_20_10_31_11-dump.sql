...
SET @@GLOBAL.GTID_PURGED=/*!80000 '+'*/ '124f3e44-f52a-11f0-bd84-0dbf99c201be:1-148';
...
INSERT INTO `article_file` (`id`, `article_id`, `path_url`, `file_type`, `is_cover`, `description`, `create_time`, `update_time`) VALUES (1,1,'http://127.0.0.1:9000/jiaxiang/2025/04/10/community_gate.jpg','image/jpeg',0,'社区简介图片','2025-04-10 19:24:00','2025-04-10 19:24:00');
...
INSERT INTO `article_profile` (`id`, `author_id`, `community_id`, `article_type_id`, `title`, `layout`, `comment_nums`, `views_nums`, `publish_time`, `created_time`, `update_time`) VALUES (1,NULL,1,1,'社区新动态',1,0,0,NULL,'2025-04-10 19:20:58','2025-09-25 15:32:28');
...
INSERT INTO `article_profile_config` (`id`, `article_profile_id`, `is_comment`, `is_show`, `is_delete`, `create_time`, `update_time`) VALUES (1,1,0,1,0,'2025-04-10 19:45:21','2025-04-10 19:45:21');
...
INSERT INTO `article_profile_content` (`id`, `article_profile_id`, `content`, `create_time`, `update_time`) VALUES (1,1,'本次更新包括了多项优化232','2025-04-10 19:46:16','2025-10-13 18:59:30');
...
INSERT INTO `community` (`id`, `name_en`, `name_cn`, `icon`, `description`, `create_time`, `update_time`) VALUES (1,'jia_he_community','嘉和社区','','嘉和社区是一个充满温暖与活力的居住区域，致力于为居民提供舒适、安全、便捷的生活环境。 社区定期举办各类活动，包括健康讲座、体育赛事、环保行动等，以增强邻里关系，促进社区文化建设。','2025-04-09 20:17:43','2025-04-12 10:21:02'),(2,'xiang_cheng_bei_yuan_community','祥城北苑社区','','祥城北苑社区是一个充满温暖与活力的居住区域，致力于为居民提供舒适、安全、便捷的生活环境。 社区定期举办各类活动，包括健康讲座、体育赛事、环保行动等，以增强邻里关系，促进社区文化建设。','2025-04-12 09:51:11','2025-04-12 10:21:02');
...
INSERT INTO `community_honor` (`id`, `communityId`, `honor`, `honor_detail`, `honor_image`) VALUES (1,1,'荣耀1','2018年，荣获“全国文明社区”称号。','image1'),(2,1,'荣耀2','2019年，被评为“优秀基层党组织','image2'),(3,1,'荣耀3','2020年，获得“社区治理创新奖','image3'),(4,1,'荣耀4','2021年，荣获\"绿色环保社区\"称号。\n\n','image4'),(5,1,'荣耀5','2022年，被评为\"最具幸福感社区\"。','image5');
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='指导清单';
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2026-01-20 10:31:11
