...
) ENGINE=InnoDB AUTO_INCREMENT=7 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='活动详情';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `activity_detail` VALUES (1,1,'健康生活','一年一度的社区运动会，欢迎大家积极参与！','本次运动会设有多项赛事，包括篮球、羽毛球、乒乓球等，设有丰富奖品。','2025-04-09 21:21:57','2025-07-04 11:39:31'),(2,2,'“祥城慧老”健身气功八段锦课堂','为推动全民健身工作，提高全民健康素质，营造全民健身的氛围，老年大学联合嘉和社区开展“八段锦”健身公益讲堂活动，旨在为居民们带来身心的放松和愉悦，更有助于居民探索健康生活的新路径。','1、嘉和社区负责布置活动场地、招募居民、宣传报道\n2、老年大学专业老师现场教学\n','2025-04-09 21:27:22','2025-06-20 09:37:29'),(3,3,NULL,NULL,'1、确定好活动时间和地点以及活动流程，给居民做好通知工作\n2、在活动当天提前布置现场，由社区工作人员做好人员引导就座\n3、活动开始社区工作人员进行现场秩序维持\n4、活动结束后，对活动进行记录和总结。','2025-06-20 09:37:29','2025-06-20 09:37:29');
...
) ENGINE=InnoDB AUTO_INCREMENT=17 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='活动所需图片/附件表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `article_profile` VALUES (1,NULL,1,1,'嘉和社区',1,0,0,NULL,'2025-04-10 19:20:58','2025-08-21 14:30:57');
...
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='社区表 标注有多少个社区';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=15 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='为人民服务详细表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=12 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='两委成员表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2025-09-23 16:51:38
