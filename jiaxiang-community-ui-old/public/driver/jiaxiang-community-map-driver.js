...
class JiaxiangCommunityMapDriver {
    ...
    parse = function () {
        ...
        communityGroups.forEach((group) => {
            const pathGroup = group.querySelector('g');
            const textGroup = group.querySelector('g:nth-of-type(2)');
            if (!pathGroup || !textGroup)
                return;
...
export { JiaxiangCommunityMapDriver };
