...
const getList = async function (currentPage: number, itemInAPage: number): Promise<Omit<ProofsDAO, "content">[]> {
...
const getDetails = async function (id: string): Promise<Omit<ProofsDAO, "id">> {
