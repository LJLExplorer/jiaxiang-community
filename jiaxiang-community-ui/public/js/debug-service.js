            ...
            const records = [
                {
                    ...
                    content: "1. ​**协助维护社会治安。​**\n" +
                        ...
                        "   - 《居住证暂行条例》第八条" // Markdown 文件路径
                },
                {
                    id: "matter-2",
                    title: "村（农村社区）依法履职事项指导清单",
                    content: "../../files/listMatters/matter1.md" // Markdown 文件路径
                },
                {
                    id: "matter-3",
                    title: "城市社区依法履职事项指导清单",
                    content: "1. **开展便民便利的社区服务活动，可以兴办有关的服务事业。**\n" +
                        "\n" +
...
self.addEventListener("fetch", function (ev) {
    console.log("API接口请求：", ev.request.url);
