...
//维护页码
    ...
    function renderMembers() {
        ...
        const container = document.getElementById("members-container") as HTMLElement;
        container.innerHTML = "";
        ...
        (document.getElementById("total-items") as HTMLElement).textContent = members.length + "";
        (document.getElementById("current-page") as HTMLElement).textContent = currentPage + "";
        (document.getElementById("total-pages") as HTMLElement).textContent = Math.ceil(members.length / itemsPerPage) + "";
    }
