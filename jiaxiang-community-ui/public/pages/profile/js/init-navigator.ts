...
import itemHomepage from "../../../common-component/navigator-regist/item-homepage.js";
...
//用于让浏览器加载完成后执行
// @ts-ignore
(mainLoader, itemHomepage, itemProfile, itemGridManagement, itemCommissioner, itemServePeople, itemMatterList, itemProof);
document.addEventListener("DOMContentLoaded", function () {
    const container = document.getElementById("navigator-container");

    mainLoader.adapter = new NavigatorAdapterIndex(container as HTMLElement, mainLoader);
