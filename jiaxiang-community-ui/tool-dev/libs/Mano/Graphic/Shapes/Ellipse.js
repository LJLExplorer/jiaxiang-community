...
let Ellipse = (() => {
    ...
    let _radiusX_decorators;
    let _radiusX_initializers = [];
    let _radiusX_extraInitializers = [];
    let _radiusY_decorators;
    let _radiusY_initializers = [];
    let _radiusY_extraInitializers = [];
    return class Ellipse extends _classSuper {
        static {
            const _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(_classSuper[Symbol.metadata] ?? null) : void 0;
            _radiusX_decorators = [NonNegativeNumber];
            _radiusY_decorators = [NonNegativeNumber];
            __esDecorate(null, null, _radiusX_decorators, { kind: "field", name: "radiusX", static: false, private: false, access: { has: obj => "radiusX" in obj, get: obj => obj.radiusX, set: (obj, value) => { obj.radiusX = value; } }, metadata: _metadata }, _radiusX_initializers, _radiusX_extraInitializers);
            __esDecorate(null, null, _radiusY_decorators, { kind: "field", name: "radiusY", static: false, private: false, access: { has: obj => "radiusY" in obj, get: obj => obj.radiusY, set: (obj, value) => { obj.radiusY = value; } }, metadata: _metadata }, _radiusY_initializers, _radiusY_extraInitializers);
            if (_metadata) Object.defineProperty(this, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        }
        x;
        y;
        radiusX = __runInitializers(this, _radiusX_initializers, void 0);
        radiusY = (__runInitializers(this, _radiusX_extraInitializers), __runInitializers(this, _radiusY_initializers, void 0));
        rotation = __runInitializers(this, _radiusY_extraInitializers);
        startAngle;
        endAngle;
        counterclockwise;
        set content(content) {
